...
*Starting R & RStudio.* &nbsp; R starts automatically when you open RStudio with a screen similar to @fig-pane-layout. 
...
*RStudio help.* &nbsp; Rstudio provides search box in the *Help* tab in the *Output pane* to make your life easier (see @fig-pane-layout).
...
*New lines.* &nbsp; R commands are usually separated by a new line but
...
*Managing objects.* &nbsp; Use function `ls()` to list the objects in your
