...
*Task.* &nbsp; Obtain a vector ('V') of unique IDs in the `term` dataset.
...
#| class: base
# base R
column_order <- union(c("hours_transfer", "mcid"), names(result_base))
result_base <- result_base[, column_order, drop = FALSE]
```
