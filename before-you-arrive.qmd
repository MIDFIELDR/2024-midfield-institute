...
While file organization is a matter of personal preference, we ask that you use the folder structure shown here for your work in the Institute workshop: 

![](figures/rproj-directory.png){width=70%}
