...
- [Install R](https://cloud.r-project.org) for your operating system  (free, open-source)
- [Install RStudio](https://www.rstudio.com/products/rstudio/download/#download), a user interface for R (free)
...
- Type the workshop name as the directory name, for example, `midfield-institute-2023`    
...
midfieldr is not yet available from [CRAN](https://cran.r-project.org/). The development version for the Institute is midfieldr 1.0.0.9030. To install from the`drat` repository, type in the Console: 
