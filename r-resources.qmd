...
- @R-rstudio-cheatsheets (The company "RStudio" was renamed "Posit" in 2022. The ) Links to downloadable help summaries (cheat sheets) for ggplot2 and many other packages. For data.table scroll down to the "Contributed cheatsheets" section. 
